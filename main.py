...
def cli():
    ...
    while not stop:
        ...
        if choice == "create habit":
            ...
            # We need period/description only to instantiate for interface, but complete works by name
            # Fetching period/description is optional, we can instantiate minimally here
            habit = Habit(name, "", "daily")
            habit.complete(db)
            print("Recorded completion.")
            ...
            choice = questionary.select(
                ...
                choices=["get all habits", "get all daily habits", "get all weekly habits", "show streak of a habit", "get longest streak", "get longest daily streak", "get longest weekly streak", "get all streaks", "get all daily streaks", "get all weekly streaks"]
            ).ask()
